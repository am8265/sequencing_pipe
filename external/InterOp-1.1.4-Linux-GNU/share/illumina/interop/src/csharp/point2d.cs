...
public class point2d : global::System.IDisposable {
  ...
  public point2d copy(point2d val) {
    point2d ret = new point2d(c_csharp_metricsPINVOKE.point2d_copy(swigCPtr, point2d.getCPtr(val)), false);
    if (c_csharp_metricsPINVOKE.SWIGPendingException.Pending) throw c_csharp_metricsPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public uint size_in_bytes() {
    uint ret = c_csharp_metricsPINVOKE.point2d_size_in_bytes(swigCPtr);
    return ret;
  }
