...
public class info : global::System.IDisposable {
  ...
  public void validate(uint lane, uint tile, string metric_name) {
    c_csharp_runPINVOKE.info_validate__SWIG_1(swigCPtr, lane, tile, metric_name);
    if (c_csharp_runPINVOKE.SWIGPendingException.Pending) throw c_csharp_runPINVOKE.SWIGPendingException.Retrieve();
  }

  public void validate_cycle(uint lane, uint tile, uint cycle, string metric_name) {
    c_csharp_runPINVOKE.info_validate_cycle(swigCPtr, lane, tile, cycle, metric_name);
    if (c_csharp_runPINVOKE.SWIGPendingException.Pending) throw c_csharp_runPINVOKE.SWIGPendingException.Retrieve();
  }

  public void validate_read(uint lane, uint tile, uint read, string metric_name) {
    c_csharp_runPINVOKE.info_validate_read(swigCPtr, lane, tile, read, metric_name);
    if (c_csharp_runPINVOKE.SWIGPendingException.Pending) throw c_csharp_runPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void write(string filename) {
    c_csharp_runPINVOKE.info_write(swigCPtr, filename);
    if (c_csharp_runPINVOKE.SWIGPendingException.Pending) throw c_csharp_runPINVOKE.SWIGPendingException.Retrieve();
  }
