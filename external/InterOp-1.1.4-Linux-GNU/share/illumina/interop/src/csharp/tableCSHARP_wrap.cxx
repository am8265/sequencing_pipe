...
SWIGEXPORT unsigned long SWIGSTDCALL CSharp_IlluminafInterOpfTable_count_table_columns___(void * jarg1) {
  unsigned long jresult ;
  std::vector< illumina::interop::model::table::imaging_column > *arg1 = 0 ;
  size_t result;
...
SWIGEXPORT void SWIGSTDCALL CSharp_IlluminafInterOpfTable_list_imaging_table_metrics_to_load___(void * jarg1) {
...
SWIGEXPORT void SWIGSTDCALL CSharp_IlluminafInterOpfTable_create_imaging_table_columns__SWIG_0___(void * jarg1, void * jarg2, void * jarg3) {
  ...
  try {
    illumina::interop::logic::table::create_imaging_table_columns((std::vector< std::string > const &)*arg1,(std::vector< bool > const &)*arg2,*arg3);
  }
  catch(illumina::interop::model::invalid_column_type &_e) {
    {
      SWIG_CSharpSetPendingExceptionCustom_invalid_column_type_CustomExceptionRegisterCallback_invalid_column_type((&_e)->what());
...
SWIGEXPORT void SWIGSTDCALL CSharp_IlluminafInterOpfTable_populate_column_offsets___(void * jarg1) {
  std::vector< illumina::interop::model::table::imaging_column > *arg1 = 0 ;
