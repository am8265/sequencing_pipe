...
public class c_csharp_plot {
  ...
  public static void list_by_cycle_metrics(metric_type_description_vector types, bool ignore_accumulated) {
    c_csharp_plotPINVOKE.list_by_cycle_metrics__SWIG_0(metric_type_description_vector.getCPtr(types), ignore_accumulated);
    if (c_csharp_plotPINVOKE.SWIGPendingException.Pending) throw c_csharp_plotPINVOKE.SWIGPendingException.Retrieve();
  }

  public static void list_by_cycle_metrics(metric_type_description_vector types) {
    c_csharp_plotPINVOKE.list_by_cycle_metrics__SWIG_1(metric_type_description_vector.getCPtr(types));
    if (c_csharp_plotPINVOKE.SWIGPendingException.Pending) throw c_csharp_plotPINVOKE.SWIGPendingException.Retrieve();
  }

  public static void filter_by_cycle_metrics(metric_type_description_vector types, bool ignore_accumulated) {
    c_csharp_plotPINVOKE.filter_by_cycle_metrics__SWIG_0(metric_type_description_vector.getCPtr(types), ignore_accumulated);
    if (c_csharp_plotPINVOKE.SWIGPendingException.Pending) throw c_csharp_plotPINVOKE.SWIGPendingException.Retrieve();
  }

  public static void filter_by_cycle_metrics(metric_type_description_vector types) {
    c_csharp_plotPINVOKE.filter_by_cycle_metrics__SWIG_1(metric_type_description_vector.getCPtr(types));
    if (c_csharp_plotPINVOKE.SWIGPendingException.Pending) throw c_csharp_plotPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public static void list_by_lane_metrics(metric_type_description_vector types, bool ignore_pf) {
    c_csharp_plotPINVOKE.list_by_lane_metrics__SWIG_0(metric_type_description_vector.getCPtr(types), ignore_pf);
    if (c_csharp_plotPINVOKE.SWIGPendingException.Pending) throw c_csharp_plotPINVOKE.SWIGPendingException.Retrieve();
  }

  public static void list_by_lane_metrics(metric_type_description_vector types) {
    c_csharp_plotPINVOKE.list_by_lane_metrics__SWIG_1(metric_type_description_vector.getCPtr(types));
    if (c_csharp_plotPINVOKE.SWIGPendingException.Pending) throw c_csharp_plotPINVOKE.SWIGPendingException.Retrieve();
  }

  public static void filter_by_lane_metrics(metric_type_description_vector types, bool ignore_pf) {
    c_csharp_plotPINVOKE.filter_by_lane_metrics__SWIG_0(metric_type_description_vector.getCPtr(types), ignore_pf);
    if (c_csharp_plotPINVOKE.SWIGPendingException.Pending) throw c_csharp_plotPINVOKE.SWIGPendingException.Retrieve();
  }

  public static void filter_by_lane_metrics(metric_type_description_vector types) {
    c_csharp_plotPINVOKE.filter_by_lane_metrics__SWIG_1(metric_type_description_vector.getCPtr(types));
    if (c_csharp_plotPINVOKE.SWIGPendingException.Pending) throw c_csharp_plotPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public static void list_flowcell_metrics(metric_type_description_vector types, bool ignore_accumulated) {
    c_csharp_plotPINVOKE.list_flowcell_metrics__SWIG_0(metric_type_description_vector.getCPtr(types), ignore_accumulated);
    if (c_csharp_plotPINVOKE.SWIGPendingException.Pending) throw c_csharp_plotPINVOKE.SWIGPendingException.Retrieve();
  }

  public static void list_flowcell_metrics(metric_type_description_vector types) {
    c_csharp_plotPINVOKE.list_flowcell_metrics__SWIG_1(metric_type_description_vector.getCPtr(types));
    if (c_csharp_plotPINVOKE.SWIGPendingException.Pending) throw c_csharp_plotPINVOKE.SWIGPendingException.Retrieve();
  }

  public static void filter_flowcell_metrics(metric_type_description_vector types, bool ignore_accumulated) {
    c_csharp_plotPINVOKE.filter_flowcell_metrics__SWIG_0(metric_type_description_vector.getCPtr(types), ignore_accumulated);
    if (c_csharp_plotPINVOKE.SWIGPendingException.Pending) throw c_csharp_plotPINVOKE.SWIGPendingException.Retrieve();
  }

  public static void filter_flowcell_metrics(metric_type_description_vector types) {
    c_csharp_plotPINVOKE.filter_flowcell_metrics__SWIG_1(metric_type_description_vector.getCPtr(types));
    if (c_csharp_plotPINVOKE.SWIGPendingException.Pending) throw c_csharp_plotPINVOKE.SWIGPendingException.Retrieve();
  }
